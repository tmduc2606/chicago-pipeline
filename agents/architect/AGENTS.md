...
- **M7**: EDA layer (notebooks, interactive exploration, Insights page). Owner: QA. **STATUS: 🟡 IN PROGRESS** — notebook + reports done, integration verification pending
- **M8**: Production hardening (monitoring, light mode toggle, About page, assessment, polish). Owner: SRE + all agents. **STATUS: 🔴 NOT STARTED**
...
- Theme: Dark-only for M6; light mode toggle in M8.
